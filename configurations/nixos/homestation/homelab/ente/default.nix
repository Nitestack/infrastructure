...
in
{
  ...
  homelab.apps.ente = {
    ...
    services.web = {
      enable = true;
      image = "ghcr.io/ente/web:latest@sha256:08db72ad19460ed554416efd0f7d0f8c00419d0b21d026ead994dc894de8e8c3";
    ...
    services.postgres = {
      enable = true;
      image = "postgres:15@sha256:5f72c7b5bd616308ccfd2e74d6be16fb06364e5eecbb815fe9dc6ab9761d2111";
